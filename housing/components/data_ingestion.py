...
class DataIngestion:
    ...
    def download_housing_data(self,):
        try:
            #extracting rremote url to download dataset
            download_url=self.data_ingestion_config.dataset_download_url

            #folder location of downloaded file
    ...
    def split_data_as_train_test(self)-> DataIngestionArtifact:
        try:
            ...
            test_file_path = os.path.join(self.data_ingestion_config.ingested_train_dir,file_name)

            if strat_train_set is not None:
                os.makedirs(self.data_ingestion_config.ingested_train_dir,exist_ok=True)
                logging.info(f"Exporting trianing dataset to file: [{train_file_path}]")
